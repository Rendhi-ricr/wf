...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <!-- Tambah::Start -->
    <form id="editor-form" action="<?= site_url('panel/faq/' . $datafaq['id_faq'] . '/edit') ?>" method="post" enctype="multipart/form-data">
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="col-md-12 mb-5">
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="title_faq" value="<?= $datafaq['title_faq'] ?>" id="judul" class="form-control mb-3" />
                            </div>
                            <div class="col-md-12">
                                <label class="form-label" for="snow-editor">Description</label>
                                <div id="snow-editor"><?= $datafaq['desc_faq'] ?></div>
                                <textarea name="desc_faq" id="content" class="d-none"><?= $datafaq['desc_faq'] ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>

...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="mb-3">
        <div class="row">
            <div class="col-md-12">
                <h1 class="h3 d-inline align-middle">Tambah Data Staff</h1>
            </div>
        </div>
    </div>

    <!-- Tambah::Start -->
    <form id="editor-form" action="<?= site_url('panel/staff/tambah') ?>" method="post" enctype="multipart/form-data">
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="col-md-8">
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="nama_staff" value="<?= set_value('nama_staff'); ?>" id="nama" class="form-control mb-3" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="jabatan" value="<?= set_value('jabatan'); ?>" id="jabatan" class="form-control mb-3" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">

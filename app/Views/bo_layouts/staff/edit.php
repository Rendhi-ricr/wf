...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="mb-3">
        <div class="row">
            <div class="col-md-12">
                <h1 class="h3 d-inline align-middle">Edit Data Staff</h1>
            </div>
        </div>
    </div>

    <!-- Tambah::Start -->
    <form id="editor-form" action="<?= site_url('panel/staff/' . $dataStaff['id_staff'] . '/edit') ?>" method="post" enctype="multipart/form-data">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-8">
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="nama_staff" value="<?= $dataStaff['nama_staff'] ?>" id="nama" class="form-control mb-3" />
                            </div>
                    ...
                    <div class="col-md-8">
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="jabatan" value="<?= $dataStaff['jabatan'] ?>" id="jabatan" class="form-control mb-3" />
                            </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <?php if ($dataStaff['photo_cover']) : ?>
                            <img id="preview" src="<?= base_url('uploads/staff/' . $dataStaff['photo_cover']) ?>" alt="Preview Image" class="img-thumbnail mb-3" style="max-width: 100%; height: auto;">
                        <?php else : ?>

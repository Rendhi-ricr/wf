...
<?= $this->section('title') ?>Kerjasama<?= $this->endSection() ?>
...
<div class="container-fluid p-0">
    ...
    <div class="mb-3">
        <div class="row">
            <div class="col-md-6">
                <h1 class="h3 d-inline align-middle">Kerjasama</h1>
            </div>
            <div class="col-md-6">
                <div class="text-end">
...
<script>
    $(document).ready(function() {
        var table = $('#ks-ajax').DataTable({
            processing: true,
            serverSide: true,
            ordering: false,
            ajax: {
                url: '<?= site_url("panel/ks/fetch"); ?>',
                type: "POST",
                data: function(d) {
                    return d;
                }
        ...
        $('#ks-ajax tbody').on('click', 'input.row-select', function() {
        ...
        $('#confirm-delete-btn').on('click', function() {
            ...
            if (ids.length > 0) {
                $.ajax({
                    url: "<?= site_url('panel/ks/trash-selected'); ?>",
                    method: 'POST',
                    data: {
                        ids: ids
                    },

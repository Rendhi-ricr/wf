...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <!-- Tambah::Start -->
    <form id="editor-form" action="<?= site_url('panel/ks/tambah') ?>" method="post" enctype="multipart/form-data">
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="col-md-8">
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="title_ks" value="<?= set_value('title_ks'); ?>" id="judul" class="form-control mb-3" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
